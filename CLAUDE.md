...
## Debugging this project — Do not use helot_run to debug helots-claude itself. Use direct Grep/Read/Slinger to investigate and direct Edit/Write to fix. helot_run is for feature work only.
## Helots
